...
Spectral contrast distribution for different genres is given in following figure.\\
...
Spectral Rolloff distribution for different genres is given in following figure.\\
...
Chroma Vector distribution for different genres is given in following figure. This feature looks more promising than others in images.\\
...
MFCC vector distribution for different genres is given in following figure.\\
\includegraphics[width=\columnwidth]{MFCC_fig}
\section{Feature Combinations- Plugins}
...
\label{sub:Music Genre Classification}
