...
We used Adaboost algorithm to fit a sequence of weak learners on repeatedly modified versions of data. We experimented it with number of esimtaros and $learning{\_}rate$ parameter. $n{\_}estimator$ controls the number of iterations on models and $learning{\_}rate$ controls the contribution of weak learners in final combination.
