...
We applied parameter learning technique to Non-linear SVM classifier. Due to time constraints, we could not do parameter learning for all the classifiers. We can clearly see in following figure that C=100 is optimal value for SVM parameter:
